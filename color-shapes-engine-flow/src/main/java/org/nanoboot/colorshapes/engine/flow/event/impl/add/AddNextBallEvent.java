...
package org.nanoboot.colorshapes.engine.flow.event.impl.add;
 ...
 * @since 0.0.0
 */
public class AddNextBallEvent extends Event {
    /**
     *
     ...
     */
    public AddNextBallEvent(
            final int column,
            final int colour,
            final int value,
            final boolean movable,
            final boolean breakable) {
        super(EventType.ADD_NEXT_BALL,
                column, colour, value, movable, breakable);
    }
}
