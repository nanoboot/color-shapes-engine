 ...
 * @since 0.0.0
 */
public class JokerBall extends Ball {
    /**
     * @param valueIn     value of the ball
     * @param movableIn   moveable of the ball
     * @param breakableIn breakable of the ball
     */
    public JokerBall(int valueIn, boolean movableIn, boolean breakableIn) {
        super(BallType.JOKER, 0, valueIn, movableIn, breakableIn);
    }
}
