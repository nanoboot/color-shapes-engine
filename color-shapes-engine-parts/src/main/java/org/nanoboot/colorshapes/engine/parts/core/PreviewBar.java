...
public class PreviewBar extends GameNode {
    ...
    private final BallPositionerGeneratorI ballPositionerGenerator;
    private List<BallPositioner> nextBalls;

    public PreviewBar(EventConsumer eventConsumer, CSRandomGenerator random, BallThrowerComposition ballThrowerComposition, BallPositionerGeneratorI ballPositionerGenerator) {
        super(eventConsumer);
    ...
    public void replaceBallPosition(int index) {
        BallPosition ballPosition = ballPositionerGenerator.generate();
