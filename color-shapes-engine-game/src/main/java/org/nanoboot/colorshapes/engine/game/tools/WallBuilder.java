 ...
 * @since 0.0.0
 */
public class WallBuilder extends GameNode {
    @Getter
    ...
    public WallBuilder(EventConsumer consumer, Board board, BoardComposition boardComposition) {
        super(consumer);
        this.board = board;

        wallProbability = boardComposition.getWallProbability().getValue();
        wallCount = boardComposition.getWallCount().getValue();
    }
}
