 ...
 * @since 0.0.0
 */
public class BallLightingTable extends StaticTable {
    ...
    public static int getId(String name) {
        Table resultOfSqlQuery = databaseConnection.executeAndReturn("SELECT id FROM ball_lighting WHERE name='" + name + "'");
    ...
    public static String getName(int id) {
        Table resultOfSqlQuery = databaseConnection.executeAndReturn("SELECT name FROM ball_lighting WHERE id=" + id);
        resultOfSqlQuery.moveToTheNextRow();
