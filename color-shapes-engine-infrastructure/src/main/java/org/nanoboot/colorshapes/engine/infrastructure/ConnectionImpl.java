...
import org.nanoboot.colorshapes.engine.dto.PlayerDetailDto;
...
public class ConnectionImpl implements Connection {
    ...
    @Override
    public void putInputEvent(String gameId, String eventAsString) {

    }

    @Override
    public void getNextOutputEvent(int gameId) {
