...
public class WidthTest {
    ...
    public void getName() {
        //prepare
        Width frd = new Width(3);
        //execute
        //assert
        assertEquals("width", frd.getName());
    }
    ...
    public void constructor_int() {
        //prepare
        Width cellDimensionImpl = new Width(1);
        //execute
        //assert
    ...
    public void constructor_empty() {
        //prepare
        Width cellDimensionImpl = new Width();
        //execute
        //assert
        assertEquals(1, cellDimensionImpl.getValue().intValue());
        assertEquals(1, cellDimensionImpl.getMinValue());
    ...
    public void constructor_jo() {
        //prepare
        Width cellDimensionImpl = new Width();
        Width cellDimensionImpl2 = new Width(cellDimensionImpl.toJsonObject());
        //execute
        //assert
