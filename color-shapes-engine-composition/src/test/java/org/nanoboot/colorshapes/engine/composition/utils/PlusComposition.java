 ...
 * @since 0.0.0
 */
public class PlusComposition extends AbstractComposition implements Composition<PlusComposition> {
    public PlusComposition() {
    }

    public PlusComposition(JsonObject jo) {
        fromJsonObject(jo);
    }
    ...
    public String getName() {
        return "plusComposition";
    }

    @Override
    public PlusComposition returnThis() {
        return this;
    }
