 ...
 * @since 0.0.0
 */
public class WallCount extends MinMaxIntHolder<WallCount> {
    /**
     ...
     */
    public WallCount(final int value) {
     ...
     */
    public WallCount(final JsonObject jo) {
        fromJsonObject(jo);
    }

    @Override
    public final WallCount returnThis() {
        return this;
    }
}
