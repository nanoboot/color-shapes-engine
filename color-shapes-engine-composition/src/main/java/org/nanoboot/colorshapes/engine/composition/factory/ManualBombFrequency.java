 ...
 * @since 0.0.0
 */
public class ManualBombFrequency extends Frequency {
    /**
     * Constructor.
     *
     * @param value    value to be hold
     */
    public ManualBombFrequency(final int value) {
        super(value);
    }
    /**
     * Constructor.
     ...
     */
    public ManualBombFrequency(final JsonObject jo) {
        super(jo);
    }

    @Override
    public final ManualBombFrequency returnThis() {
        return this;
    }
    @Override
